...
const TABS = [
    {
        ...
        description: '<p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Quibusdam quidem ipsam ratione dicta quis cupiditate consequuntur laborum ducimus iusto velit.</p>',
...
export default function FeaturesGallery() {
    ...
    const imagesMarkup = TABS.map((singleTab, idx) => {
        ...
        const isFirst = idx === 0;
        return (<ImageContainer key={singleTab.title} isActive={isActive}>
    ...
    const tabsMarkup = TABS.map((singleTab, idx) => {
        const isActive = singleTab.title === currentTab.title;
        return (<Tab isActive={isActive} key={idx} onClick={() => handleTabClick(idx)}>
        <TabTitleContainer>
          <CircleContainer>
...
const FeaturesGalleryWrapper = styled(CustomContainer) `
  display: flex;
  align-items: center;
