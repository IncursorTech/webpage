  ...
  return (
    <Box mt={"10rem"} mb={"10rem"} maxW="150em" mx={'auto'} pb={5} px={{ base: 2, sm: 12, md: 17 }}>
      ...
      <SimpleGrid columns={{ base: 2, md: 4 }} spacing={{ base: 5, lg: 8 }}>
        <StatsCard
          title={t("statics:team")}
          stat={'13'}
          icon={<IoIosPeople size={'5em'} popoverContent={'There are 5 engineers and 8 technical personnel in our company.'} />}
        />
        <StatsCard title={t("statics:branch")} stat={'5'} icon={<IoIosRibbon size={'5em'} />} />
        <StatsCard title={t("statics:locations")} stat={'2'} icon={<GoLocation size={'5em'} />} />
        <StatsCard title={t("statics:partners")} stat={'5'} icon={<IoMdPeople size={'5em'} />} />
      </SimpleGrid>
    </Box>
  );
}
