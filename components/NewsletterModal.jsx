...
export default function NewsletterModal({ onClose }) {
    ...
    return (<MailchimpSubscribe url={EnvVars.MAILCHIMP_SUBSCRIBE_URL} render={({ subscribe, status, message }) => {
            ...
            <CustomContainer>
              <Card onSubmit={(event) => onSubmit(event, subscribe)}>
                ...
                {!hasSignedUp && (<>
                    ...
                    <Row>
                      <CustomInput value={email} onChange={(e) => setEmail(e.target.value)} placeholder="Enter your email..." required/>
