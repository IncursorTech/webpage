...
function TreatmentPricesComparison({ cities, selectedCity, onSelect }: Props) {
  return (
    <Box py={12}>
        ...
        {cities.map((city, index) => (
          <PriceWrapper key={index}>
            <Box position="relative">
              {city.isMostPopular && (
                <Box position="absolute" width={'70%'} top="-20px" left="50%" style={{ transform: 'translate(-50%)' }}>
              ...
              <VStack bg="gray.50" py={4} borderBottomRadius={'xl'}>
                ...
                <Box w="80%" pt={7}>
                  <Button
                    ...
                    w="full"
                    colorScheme="cyan"
                    variant={selectedCity?.code === city.code ? 'solid' : 'outline'}
