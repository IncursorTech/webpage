...
export default function Code({ code, language = 'javascript', selectedLines = [], withCopyButton = true, withLineNumbers, caption, }) {
    ...
    const copyButtonMarkup = (<ClientOnly>
        ...
        {({ className, style, tokens, getLineProps, getTokenProps }) => (<>
            <CodeWrapper className="code-wrapper" language={language}>
              ...
              <Pre className={className} style={style}>
                ...
                return (<Line key={i} {...{ ...lineProps, className }}>
...
function CopyIcon() {
    return (<svg viewBox="0 0 24 24" focusable="false" className="chakra-icon css-onkibi">
