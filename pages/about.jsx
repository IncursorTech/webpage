        ...
        <InsideContainer>
          <SimpleGrid mb={"5rem"} columns={{ base: 1, sm: 1, md: 1 }} spacing={10} mt={"5rem"}>
            <Box border={'2px'} rounded={'lg'} fontSize={'lg'} p={10}>
              <chakra.p>
                {t("about:description.content-start")}
                <br></br>
                <br></br>
                {t("about:description.slogan")}
                <br></br>
                <br></br>
                {t("about:description.content-center")}
                <br></br>
                <br></br>
                {t("about:description.content-end")}
              </chakra.p>
            </Box>
          </SimpleGrid>
          ...
          <Box border={'2px'} rounded={'lg'} fontSize={'lg'} p={10}>
            ...
            <SimpleGrid columns={{ base: 1, sm: 1, md: 1 }} spacing={10}>
              ...
              <chakra.p mt={3} opacity={sendInfo} fontSize={{base:"sm" , md:"md"}}> Mailiniz başarılı bir şekilde gönderilmiştir.</chakra.p>
