                  ...
                  <Box my={24} m>
                    <div className="row">
                      <div className="col-md-4">
                        <Box mx={4}>
                          <Calendar value={selectedDate} onChange={setSelectedDate} disabledDays={disabledDates} // here we pass them
     onDisabledDayError={handleDisabledSelect} // handle error
     shouldHighlightWeekends shouldHighlightToday colorPrimary="#48BB78"/>
                        </Box>
                      </div>
                      <div className="col-md-8">
                        <SimpleGrid columns={4} spacing={2} p={4}>
                          {timeSlots.map((time, index) => (<Button key={index} 
        // colorScheme={selectedTimeSlotIndex === index ? 'teal' : 'teal'}
        bg={selectedTimeSlotIndex === index ? 'green.400' : 'white'} color={selectedTimeSlotIndex === index ? 'white' : 'black'} shadow="lg" size="lg" onClick={() => {
            ...
            <div className="col-md-3">
              <LeftContentContainer>
                ...
                <Box bottom={0}>
                  <Button mt={'2rem'} p={8} w={'full'} h={'full'} bg={'green.400'} color={'white'} rounded={'xl'} boxShadow={'0 5px 20px 0px rgb(72 187 120 / 43%)'} onClick={() => {
            saveAppointment();
        }} _hover={{
            bg: 'green.500',
        }} _focus={{
